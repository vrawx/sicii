...
public class OrganizacaoDAO extends AbstractBaseEntityDAO<Organizacao> implements IOrganizacaoDAO{

	@Override
	protected MontaWhere consultaWhere(Organizacao baseEntity) {
		@Override
